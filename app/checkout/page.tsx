"use client";
  ...
  const CheckoutPage: React.FC = () => {
    ...
    const handleCheckout = async (e: React.FormEvent) => {
      ...
      try {
        ...
        if (paymentMethod === "stripe") {
          console.log("Initiating Stripe checkout to /api/webhooks/create-checkout-session");
          ...
          const nowPaymentsResponse = await fetch(
            "https://api.nowpayments.io/v1/invoice",
            {
              ...
              body: JSON.stringify({
                ...
                order_description: `Payment for plan ${plan?.type || "hashrate"} - ${plan?.hashrate} TH/s`,
    ...
    const planType = plan.type || "hashrate";
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg">
                ...
                <span className="text-white">
                  ${plan.price || "0.00"} {plan.currency || "USD"}
                </span>
              </p>
              <p className="text-lg">
