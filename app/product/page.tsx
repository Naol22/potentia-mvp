...
const buy = () => {
  ...
  return (
    <section>
      ...
      {/* Plans and Mining Hosts sections with AnimatePresence */}
          ...
          >
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
              ...
              <div className="bg-gray-200 p-6 rounded-lg shadow-md relative z-10">
                ...
                <button
                 className="mt-8 px-12 py-4 bg-zinc-800/80 border border-zinc-700 text-white rounded-full hover:bg-zinc-700/80 transition-all duration-300 text-xl disabled:opacity-50 disabled:pointer-events-none"
                 onClick={() => {
                   setSelectedPlan(null);
                   setSelectedHashRate(null);
                 }}
