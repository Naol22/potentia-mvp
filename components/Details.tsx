...
const Details = () => {
  ...
  if (!plan || !crypto || !hashRate || !duration || !total || !minerModel) {
    return (
      <div className="bg-black text-white min-h-screen p-8 mt-44">
  ...
  // Construct query string for the checkout page
...
\n            </div>
            <div className="mt-6">
              <Link href={`/checkout?${checkoutQueryParams}`}>
